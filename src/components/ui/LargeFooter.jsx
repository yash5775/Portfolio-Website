...
const TimeDisplay = () => {
    ...
    return <p className="text-white/40 text-sm font-mono mt-2">{time}</p>;
};

export default function LargeFooter() {
    return (
        <footer className="relative w-full bg-[#111111] text-white pt-32 pb-12 px-6 md:px-12 overflow-hidden z-20">

            <div className="w-full max-w-[1240px] mx-auto border-t border-white/10 pt-20">

                {/* 1. Big CTA Section */}
                <div className="mb-24 flex flex-col items-start">
                    <div className="flex items-center gap-4 mb-8">
                        <div className="w-3 h-3 rounded-full bg-lime-400 animate-pulse" />
                        <span className="text-white/60 uppercase tracking-widest text-sm">Open to new opportunities</span>
                    </div>

                    <h2 className="text-6xl md:text-[8rem] font-bold tracking-tighter leading-[0.9] mb-12">
                        Let's work <br /> <span className="text-white/30">together.</span>
                    </h2>

                    <a href="mailto:hello@yash.com" className="inline-flex items-center gap-4 px-8 py-4 bg-white text-black rounded-full font-bold text-lg hover:bg-lime-400 transition-colors duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 border-t border-white/10 pt-12">
                    ...
                    <div className="flex flex-col gap-4">
                        <h4 className="text-white/40 uppercase text-xs tracking-wider mb-2">Navigation</h4>
                    ...
                    {/* Column 2: Socials */}
                    <div className="flex flex-col gap-4">
                        <h4 className="text-white/40 uppercase text-xs tracking-wider mb-2">Socials</h4>
                    ...
                    {/* Column 3: Contact */}
                    <div className="flex flex-col gap-4">
                        <h4 className="text-white/40 uppercase text-xs tracking-wider mb-2">Contact</h4>
                    ...
                    <div className="flex flex-col justify-between">
                        <div>
                            <h4 className="text-white/40 uppercase text-xs tracking-wider mb-2">Local Time</h4>
                            <TimeDisplay />
                        </div>
